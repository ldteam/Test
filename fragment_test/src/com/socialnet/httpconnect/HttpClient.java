...
public class HttpClient {
	...
	public byte[] downloadImage(String imgName) {
		...
		//забираем байты  выходной массив
	...
	public void connectForMultipart() throws Exception {
	    ...
	    con.setRequestMethod("POST");
		Log.v("My", "HttpClient"+url);
		con.setDoInput(true);
		con.setDoOutput(true);
		//request
	con.setRequestProperty("Connection", "Keep-Alive");
		//Тип содержимого multipart/form-data — это составной тип содержимого,
		//чаще всего использующийся для отправки HTML-форм с бинарными данными методом POST протокола HTTP
	con.setRequestProperty("Content-Type", "multipart/form-data; boundary=" + boundary);

		con.connect();
	
		//забираем выходной поток
