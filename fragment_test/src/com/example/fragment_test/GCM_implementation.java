...
public class GCM_implementation {
	...
	public static final String EXTRA_MESSAGE = "message";
	  ...
	  //позволяют одновременное обращение к переменным,  используются как  счетчики в многопоточных приложениях
	    ...
	    {
	    	Log.i("My", "GCM_implementation.CheckDeviceForPlayServiceAPK()");
	       ...
	       gcm = GoogleCloudMessaging.getInstance(context);
	    	...
	    	if (regid.isEmpty()) {
	    		Log.i("My", "GCM_implementation.CheckDeviceForPlayServiceAPK() reg_id is empty");
	  ...
	  int resultCode = GooglePlayServicesUtil.isGooglePlayServicesAvailable(context);
	            ...
	            //    Log.i(TAG, "GCM_implementation.registerInBackground() "+ msg);
	                ...
	                try {
	                    if (gcm == null) {
	                        ...
	                        Log.i(TAG, "GCM_implementation.registerInBackground() try "+ msg);
	    ...
	    private void sendRegistrationIdToBackend() {
			...
			ListEntry list2 = new ListEntry();
			  ...
			  list2.Add(new MyEntry<String, String>("user_id", UserId.ID));
			  list2.Add(new MyEntry<String, String>("reg_id", regid));
